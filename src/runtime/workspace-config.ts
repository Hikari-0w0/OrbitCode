...
import {
  MAX_WORKSPACE_ID_LENGTH as CATALOG_MAX_ID_LENGTH,
  MAX_WORKSPACE_NAME_LENGTH as CATALOG_MAX_NAME_LENGTH,
  MAX_WORKSPACES as CATALOG_MAX_WORKSPACES,
  type WorkspaceSummary,
} from "@/runtime/types";

export const MAX_WORKSPACES = CATALOG_MAX_WORKSPACES;
export const MAX_WORKSPACE_ID_LENGTH = CATALOG_MAX_ID_LENGTH;
export const MAX_WORKSPACE_NAME_LENGTH = CATALOG_MAX_NAME_LENGTH;
